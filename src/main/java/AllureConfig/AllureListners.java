 ...
 * org.apache.logging.log4j.Logger; import org.openqa.selenium.OutputType;
 ...
 * LogManager.getLogger(AllureTestNGListerners.class);
 * 
 ...
 * 
 * @Attachment(value = "{0}", type = "text/html") public static String
 * attachHtml(String html) { return html; }
 * 
 ...
 * ExtentReports log operation for passed tests. // getTest().log(Status.PASS,
 * "Test passed"); }
 * 
 ...
 * testClass = iTestResult.getInstance(); WebDriver driver = ((BaseClass)
 * testClass).getLdriver();
 * 
 ...
 * 
 * // Save a log on allure. saveTextLog(getTestMethodName(iTestResult) +
 ...
 * ExtentReports log operation for skipped tests. // getTest().log(Status.SKIP,
 * "Test Skipped"); }
 * 
 * @Override public void onTestFailedButWithinSuccessPercentage(ITestResult
 * iTestResult) { logger.info("Test failed but it is in defined success ratio "
